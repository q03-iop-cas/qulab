...
class Driver(BaseDriver):
    ...
    quants = [
        ...
        Q('Ext Term', unit='', type=OPTION, set_cmd='TERM 0,%(option)s', get_cmd='TERM? 0',
            options=[('50 Ohm', '0'), ('1 MOhm', '1')]),
        Q('A Term', unit='', type=OPTION, set_cmd='TERM 1,%(option)s', get_cmd='TERM? 1',
            options=[('50 Ohm', '0'), ('1 MOhm', '1')]),
        Q('B Term', unit='', type=OPTION, set_cmd='TERM 2,%(option)s', get_cmd='TERM? 2',
            options=[('50 Ohm', '0'), ('1 MOhm', '1')]),
        Q('Ext Slope', unit='', type=OPTION, set_cmd='TSLP 0,%(option)s', get_cmd='TSLP? 0',
            options=[('Positive', '0'), ('Negative', '1')]),
        Q('A Slope', unit='', type=OPTION, set_cmd='TSLP 1,%(option)s', get_cmd='TSLP? 1',
            options=[('Positive', '0'), ('Negative', '1')]),
        Q('B Slope', unit='', type=OPTION, set_cmd='TSLP 2,%(option)s', get_cmd='TSLP? 2',
            options=[('Positive', '0'), ('Negative', '1')]),
        Q('A Coupling', unit='', type=OPTION, set_cmd='TCPL 1,%(option)s', get_cmd='TCPL? 1',
            options=[('DC', '0'), ('AC', '1')]),
        Q('B Coupling', unit='', type=OPTION, set_cmd='TCPL 2,%(option)s', get_cmd='TCPL? 2',
            options=[('DC', '0'), ('AC', '1')]),
