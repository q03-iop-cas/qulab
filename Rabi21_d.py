...
ME_LEN   = 1000
TRIGGER_DELAY = 180
t_range = np.linspace(20,2020,1001)   # ns
...
class MyApp(Application):
    ...
    def set_datas(self):
        ...
        self.data.template(
            name="Rabi", fname='rabi21_d_{autoname}.txt',
    ...
    def set_plots(self):
        ...
        def get_data(app = self):
            ...
            p0, e = app.data["Rabi"]['P0']
            p1, e = app.data["Rabi"]['P1']
            p2, e = app.data["Rabi"]['P2']

            return x, [p0, p1, p2]

        self.plot.add_item(curves("Rabi21",
                                 "Time (ns)",
    ...
    @step()
    def set_time(self, t):
        points = np.array([0]*int(READ_OUT-t+EX21_DELAY) + [1]*int(t) + [0]*int(self.cfg['WAVEFORM_SIZE']-READ_OUT-EX21_DELAY))
        mk = "0"*(READ_OUT-t+EX21_DELAY) + "1"*t + "0"*(self.cfg['WAVEFORM_SIZE']-READ_OUT-EX21_DELAY)
    ...
    def measurement(self):
        ...
        self.data["Rabi"].append(P0 = (P0, e0),
                                 P1 = (P1, e1),
                                 P2 = (P2, e2))
