...
class MyApp(Application):
    ...
    @step()
    def set_time(self, t):
        points = np.array([0]*int(READ_OUT-t-PI_LEN+EX_DELAY) + [1]*int(PI_LEN) + [0]*int(self.cfg['WAVEFORM_SIZE']-READ_OUT-EX_DELAY+t))
        mk = "0"*(READ_OUT-t-PI_LEN+EX_DELAY) + "1"*PI_LEN + "0"*(self.cfg['WAVEFORM_SIZE']-READ_OUT-EX_DELAY+t)
